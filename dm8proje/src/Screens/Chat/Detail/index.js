...
import {View, Text, SafeAreaView, TouchableOpacity, FlatList, TextInput, StyleSheet, TouchableOpacityBase } from 'react-native';
    ...
    render() {
        ...
        return (
            <SafeAreaView style={{flex:1}}>
                ...
                keyExtractor={(item,index)=>index.toString()} //hata verdiği için ekledik
                />
